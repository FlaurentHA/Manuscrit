...
Note that the slopes $|dD/dF|$ are very much additive and almost seven times larger than in the case of F//Z.
...
\begin{table}
    \begin{tabular}{c | c c c c c c c c}
        $H_{ms}$ & $\ket{abc}$ & $\ket{ab\overline{c}}$ & $\bra{a\overline{b}c}$ & $\bra{\overline{a}bc}$ & $\bra{a\overline{b}\overline{c}}$ & $\bra{\overline{a}b\overline{c}}$ & $\bra{\overline{a}\overline{b}c}$ & $\bra{\overline{a}\overline{b}\overline{c}}$\\
        \hline
