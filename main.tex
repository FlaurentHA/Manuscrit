...
Let's define $\Delta w(X-Y)$ which is the difference between the weight w($d_{xz}$) and w($d_{yz}$) and its overall variation $\Delta (\Delta w(X-Y))$ between $+F$ and $-F$ as reported in Table .
...
Now, let's consider the applied field along the Y direction, the field is now not aligned with the main component of the dipole moment ($\mu_z$). Note that the field is not directly applied along the Ni-N$_3$ bond as it is slightly ou
The application of the electric field will lead to a change in sign of the $\mu_y$ component as can be observed from the quadratic behavior of the ground state energy represented on figure \ref{GSE_Y}.
...
%%% Matrice dans la bases des etats couplés sans les 
