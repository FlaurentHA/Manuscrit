...
These operators were first derived to describe the lift of degeneracy induced by the crystal field potential studid in spectroscopy.
Note that this formalism is not resticted to transition metals but can also be used on rare earth.
The ZFS is now described by the more complete model Hamiltonian:
...
The ZFS parameters are related to the second rank Stevens paramters:
...
This tensor can be split in three compoentns, an isotropic term that relates to the HDvV Hamiltonian and two anisotropic terms.
...
where the first term is the isotropic exchange.
