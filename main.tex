...
The electronic effect included are the isotropic couplings $J_i$ between tripplet and singlet states of same spatial nature. 
...
The spin-orbit couplings between these states originate from the $\hat{l}_z\hat{s}_z$ part of the $\hat{H}^{SO}$ that couples the determinants formed from orbitals of same spatial ($m_l$) and spin ($m_s$) component.
...
The evolution of the axial term $D_{AB}$ as a function of the angle $\phi$ is shown on figure \ref{Cu2Cl5Angle}. 
The angle has been varied from $\phi=170\degree$ to $\phi=130\degree$ with no external field applied, the system is still centrosymmetric as such the DMI is naught.
As the angle $\phi$ decreases the magnitude $|D_{AB}|$ increases as well 
