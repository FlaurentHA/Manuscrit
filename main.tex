...
The orbital configuration is dictated by a pentadentate ligand in the equatorial plane, which enforce a pentagonal bipyramidal geometry around the metallic center with halides or H$_2$O ligands in the apical positions.
The corresponding structure is depicted in Figure \ref{FeComplex}
...
\begin{figure}[!ht]
    ...
    \label{FeComplex}
\end{figure}
This allows the condition of near-degeneracy of the $d_{xz}$ and $d_{yz}$ to be achieved and .
