...
Once again the contribution that is the most affected by the electric field is that of the first excited state $T^1$.
...
This destabilize the $d_{x^2-y^2}$ which point directly toward N$_3$ and stabilize the $d_{xy}$ resulting in an increase of difference of energy between states.
