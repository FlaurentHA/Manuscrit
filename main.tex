...
\geometry{letterpaper,top=2.5cm,bottom=2.5cm,left=2.5cm,right=2.5cm,marginparwidth=1.75cm}
...
First, we can observe the small variation in case (b) which matches well the variation of $E$ for this case as can be seen in Fig. \ref{fig:Ni_E_Z}.
...
\begin{itemize}
    ...
    In case (a) for $\vec{\vb{F}}\parallel Z$, the large increase in magnitude $|D|$ can be related to a large variation of the SOC while the energy difference $\Delta E$ between $T^0$ and $T^1$ decreases.
...
This procedure was tested on a simple model molecule, shown in Figure \ref{MolCu2Cl5}, consisting of two $Cu^{2+}$ cations bond to $Cl^-$ anions.
\begin{figure}[!ht]
    \centering
...
Nevertheless, it was used for the treatment of second-order spin orbit coupling.
...
The continious electric field was added in the SEWARD stage of the calculation in MOLCAS, the electric field was applied along the X,Y and Z directions but most of the results reported here relates to the Y direction.
